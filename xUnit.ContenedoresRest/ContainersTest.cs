...
namespace xUnit.ContenedoresRest
{
    public class ContainersTest
    {
        ...
        public void Containers_selectContainers_ContainersDespachados()
        {
            ...
            StatsManagerl objContainer = new StatsManagerl();
           // var lstContainers = objContainer.selectContainers(budget, objModel);
        ...
        //    /// </summary>
        //    [Fact]
        //    public void Containers_selectContainers_ContainersBudgetCero()
        //    {
        //        double budget = 0;
        //        List<ContainersModel> objModel = new List<ContainersModel>();
        //        objModel.Add(new ContainersModel
        ...
        //        //Assert.Equal(new string[] {}, lstContainers);
        //    }
        //    [Fact]
        //    public void Containers_selectContainers_ContainersTransportCostCero()
        //    {
        //        double budget = 1508.65;
        //        List<ContainersModel> objModel = new List<ContainersModel>();
        //        objModel.Add(new ContainersModel
        ...
        //        StatsManagerl objContainer = new StatsManagerl();
        //        //List<string> lstContainers = objContainer.selectContainers(budget, objModel);
        //        //Assert.Equal(new string[] { "c1", "c2", "c3", "c4","c5", }, lstContainers);
        //    }
